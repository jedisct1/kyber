...
pub fn compress(a: &PolyVec, r: &mut [u8; POLYVECCOMPRESSEDBYTES]) {
    ...
    for poly in a {
        for i in 0..(N / 8) {
            for j in 0..8 {
                t[j] = ((((u32::from(freeze(poly[8 * i + j])) << 11) + Q as u32 / 2) / Q as u32)
                    & 0x7ff) as u16;
            }
...
pub fn decompress(r: &mut PolyVec, a: &[u8; POLYVECCOMPRESSEDBYTES]) {
    ...
    for poly in r {
        for i in 0..(N / 8) {
            poly[8 * i] = ((((u32::from(a[p + 11 * i])
                | ((u32::from(a[p + 11 * i + 1]) & 0x07) << 8))
                * Q as u32)
                + 1024)
                >> 11) as u16;
            poly[8 * i + 1] = (((((u32::from(a[p + 11 * i + 1]) >> 3)
                | ((u32::from(a[p + 11 * i + 2]) & 0x3f) << 5))
                * Q as u32)
                + 1024)
                >> 11) as u16;
            poly[8 * i + 2] = (((((u32::from(a[p + 11 * i + 2]) >> 6)
                | ((u32::from(a[p + 11 * i + 3]) & 0xff) << 2)
                | ((u32::from(a[p + 11 * i + 4]) & 0x01) << 10))
                * Q as u32)
                + 1024)
                >> 11) as u16;
            poly[8 * i + 3] = (((((u32::from(a[p + 11 * i + 4]) >> 1)
                | ((u32::from(a[p + 11 * i + 5]) & 0x0f) << 7))
                * Q as u32)
                + 1024)
                >> 11) as u16;
            poly[8 * i + 4] = (((((u32::from(a[p + 11 * i + 5]) >> 4)
                | ((u32::from(a[p + 11 * i + 6]) & 0x7f) << 4))
                * Q as u32)
                + 1024)
                >> 11) as u16;
            poly[8 * i + 5] = (((((u32::from(a[p + 11 * i + 6]) >> 7)
                | ((u32::from(a[p + 11 * i + 7]) & 0xff) << 1)
                | ((u32::from(a[p + 11 * i + 8]) & 0x03) << 9))
                * Q as u32)
                + 1024)
                >> 11) as u16;
            poly[8 * i + 6] = (((((u32::from(a[p + 11 * i + 8]) >> 2)
                | ((u32::from(a[p + 11 * i + 9]) & 0x1f) << 6))
                * Q as u32)
                + 1024)
                >> 11) as u16;
            poly[8 * i + 7] = (((((u32::from(a[p + 11 * i + 9]) >> 5)
                | ((u32::from(a[p + 11 * i + 10]) & 0xff) << 3))
                * Q as u32)
                + 1024)
                >> 11) as u16;
        }
